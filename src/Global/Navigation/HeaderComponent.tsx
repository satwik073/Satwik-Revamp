...
const HeaderComponent = () => {
    return (
        <React.Fragment>
            <BoxTypeIdentifier.Default className='w-full h-[4rem] bg-black/10 flex items-center justify-between text-[14px] tracking-tight px-4'>
                {/* Main title - responsive with truncation */}
                <BoxTypeIdentifier.Default className='flex-1 h-full flex items-center justify-center font-[500] text-center'>
                    <div className='truncate max-w-[200px] md:max-w-full'>
                        <span className='hidden sm:inline'>Software Developer | Published Researcher | Apple Collaboration</span>
                        <span className='sm:hidden'>Software Developer | Researcher</span>
                    </div>
                </BoxTypeIdentifier.Default>

                {/* Contact info - responsive with icons only on small screens */}
                <BoxTypeIdentifier.Default className='flex-1 h-full flex items-center justify-end md:justify-center font-[500]'>
                    <BoxTypeIdentifier.Default className='flex items-center justify-end gap-x-6 lg:gap-x-8 font-[500]'>
                        <BoxTypeIdentifier.Default className='font-[500] flex items-center justify-center gap-x-1 sm:gap-x-2'>
                        ...
                        <BoxTypeIdentifier.Default className='font-[500] flex items-center justify-center gap-x-1 sm:gap-x-2'>
                            ...
                            <div className='hidden lg:block truncate max-w-[200px]'>
                                satwikkanhere2003@gmail.com
                            </div>
                        </BoxTypeIdentifier.Default>
                        <BoxTypeIdentifier.Default className='font-[500] flex items-center justify-center gap-x-1 sm:gap-x-2'>
                            <MessageCircle size={16} className='flex-shrink-0' />
                            <div className='hidden md:block truncate max-w-[100px]'>
                                Chat with us
                            </div>
                        </BoxTypeIdentifier.Default>
                    </BoxTypeIdentifier.Default>
            ...
            <BoxTypeIdentifier.Default className=' w-full h-[4rem] backdrop-blur-md bg-[rgba(255,255,255,1)] flex items-center justify-center text-[14px] text-black tracking-tightest'>
                <div className='flex items-center justify-start max-w-[200px] md:max-w-full truncate'>
                    <div className='w-24 h-24 flex items-center justify-center flex-shrink-0'>
                        <svg xmlns="http://www .w3.org/2000/svg" viewBox="0 0 109.21 36" role="img" aria-labelledby="okta-logo">
                    ...
                    <div className='flex items-center justify-start -ml-12 text-xl tracking-tight font-bold truncate'>
                        Satwik Kanhere
                    </div>
                </div>
            </BoxTypeIdentifier.Default>
            <BoxTypeIdentifier.Default className='w-full h-[2.5rem] backdrop-blur-lg  bg-[rgba(255,255,255,0.9)]  flex items-center justify-center text-[14px] text-black tracking-tightest'>
                <StoreNavigation />
            </BoxTypeIdentifier.Default>
        </React.Fragment>
    )
